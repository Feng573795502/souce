...
HD_PWD='H:/FPGA/souce/12_uart_rx_byte/uart_rx_byte.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_rx_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_rx_test.tcl -notrace
