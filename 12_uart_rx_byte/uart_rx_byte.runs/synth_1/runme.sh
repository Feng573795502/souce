...
HD_PWD='H:/FPGA/souce/12_uart_rx_byte/uart_rx_byte.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_rx_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_rx_test.tcl
