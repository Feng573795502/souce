...
HD_PWD='H:/FPGA/souce/05_key_led/key_led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log key_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source key_led.tcl -notrace
