...
HD_PWD='H:/FPGA/souce/05_key_led/key_led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log key_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source key_led.tcl
