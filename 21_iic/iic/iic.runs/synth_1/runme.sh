...
HD_PWD='H:/FPGA/souce/21_iic/iic/iic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iic_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iic_ctrl.tcl
