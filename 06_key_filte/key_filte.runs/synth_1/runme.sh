...
HD_PWD='H:/FPGA/souce/06_key_filte/key_filte.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log key_filte.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source key_filte.tcl
