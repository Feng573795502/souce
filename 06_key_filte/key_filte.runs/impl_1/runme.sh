...
HD_PWD='H:/FPGA/souce/06_key_filte/key_filte.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log key_filte.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source key_filte.tcl -notrace
