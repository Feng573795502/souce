...
HD_PWD='H:/FPGA/souce/25_lvds/lvds.runs/selectio_wiz_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log selectio_wiz_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source selectio_wiz_0.tcl
