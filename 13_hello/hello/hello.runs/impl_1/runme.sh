...
HD_PWD='H:/FPGA/souce/13_hello/hello/hello.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hello_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hello_test.tcl -notrace
