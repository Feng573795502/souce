...
HD_PWD='G:/FPGA/souce/13_hello/hello/hello.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hello.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hello.tcl -notrace
