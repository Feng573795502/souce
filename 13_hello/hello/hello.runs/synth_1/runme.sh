...
HD_PWD='G:/FPGA/souce/13_hello/hello/hello.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hello.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hello.tcl
