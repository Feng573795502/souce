...
HD_PWD='H:/FPGA/souce/18_ram_proc/ram_proc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_dpram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_dpram.tcl
