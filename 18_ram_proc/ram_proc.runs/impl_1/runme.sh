...
HD_PWD='H:/FPGA/souce/18_ram_proc/ram_proc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_dpram.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_dpram.tcl -notrace
