...
HD_PWD='H:/FPGA/souce/23_sdram_control/sdram_control.runs/fifo_rd_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_rd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_rd.tcl
