...
HD_PWD='H:/FPGA/souce/11_uart_tx/uart_tx.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_tx_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_tx_test.tcl
