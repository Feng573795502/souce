...
HD_PWD='H:/FPGA/souce/27_math/math.runs/fixed_to_float_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fixed_to_float.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fixed_to_float.tcl
