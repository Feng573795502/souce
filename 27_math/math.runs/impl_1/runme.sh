...
HD_PWD='H:/FPGA/souce/27_math/math.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log addsub_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source addsub_test.tcl -notrace
