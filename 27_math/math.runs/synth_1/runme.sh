...
HD_PWD='H:/FPGA/souce/27_math/math.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log addsub_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source addsub_test.tcl
